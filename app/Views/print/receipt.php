...
<head>
    <meta charset="UTF-8">
    <title>إيصال قسط - <?= htmlspecialchars($installment['invoice_number']) ?></title>
        ...
        <div class="receipt">
            ...
            <div class="header-right">
                <div class="inst-box">
                    ...
                    <div class="inst-box-num"><?= $installment['installment_number'] ?> / <?= $installment['total_installments_count'] ?></div>
                </div>
            </div>
            <div class="header-center">
                ...
                <div class="branch-name"><?= htmlspecialchars($installment['branch_data']['name'] ?? '') ?></div>
            </div>
            <div class="header-left">
                    <div class="company-phone"><?= htmlspecialchars($company['company_phone'] ?? '') ?></div>
                    <div class="branch-phone"><?= htmlspecialchars($installment['branch_data']['phone'] ?? '') ?></div>
                </div>
            </div>
            ...
            <div class="content">
                <div class="col">
                    <div class="box">
                        ...
                        <div class="info-row"><span>كود العميل:</span><strong><?= $installment['customer_id'] ?></strong></div>
                        <div class="info-row"><span>اسم العميل:</span><strong><?= htmlspecialchars($installment['customer_name']) ?></strong></div>
                        <div class="info-row"><span>رقم التليفون:</span><strong><?= htmlspecialchars($installment['phone'] ?: '-') ?></strong></div>
                        <div class="info-row"><span>المنطقة:</span><strong><?= htmlspecialchars($installment['area'] ?: '-') ?></strong></div>
                        <div class="info-row"><span>العنوان:</span><strong><?= htmlspecialchars($installment['address'] ?: '-') ?></strong></div>
                    </div>
                    
                    <div class="dates-row">
                        <div class="date-box">
                            <span class="date-label">تاريخ:</span>
                            <span class="date-val"><?= htmlspecialchars($installment['due_date']) ?></span>
                        </div>
                        <div class="date-box">
                            <span class="date-label">القادم:</span>
                            <span class="date-val"><?= htmlspecialchars($installment['next_installment_date'] ?? 'الأخيرة') ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col">
                    <div class="box">
                        ...
                        <div class="info-row"><span>رقم الفاتورة:</span><strong><?= htmlspecialchars($installment['invoice_number']) ?></strong></div>
                        <div class="info-row"><span>إجمالي الفاتورة:</span><strong><?= number_format($installment['total']) ?></strong></div>
                        <div class="info-row"><span>تاريخ الفاتورة:</span><strong><?= $installment['invoice_date'] ?></strong></div>
                        <div class="info-row"><span>المقدم:</span><strong><?= number_format($installment['paid_upfront']) ?></strong></div>
                        <div class="info-row"><span>عدد الأقساط:</span><strong><?= $installment['total_installments_count'] ?></strong></div>
                    </div>
                    
                    <div class="amount-row">
                        <div class="amount-box">
                            <span class="amount-label">المبلغ:</span>
                            <span class="amount-value"><?= number_format($installment['amount']) ?></span>
                        </div>
                        <div class="remain-box">
                            <span class="remain-label">المتبقي:</span>
                            <span class="remain-value"><?= number_format($installment['remaining_after_this']) ?></span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bottom-section">
                ...
                <div class="rep-bar">
                    <span><strong>المندوب:</strong> <?= htmlspecialchars($installment['sales_rep_name'] ?? 'غير محدد') ?></span>
                    <span><strong>ت:</strong> <?= htmlspecialchars($installment['sales_rep_phone'] ?? '-') ?></span>
                </div>
            </div>
        </div>
    </div>
